...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
    ...
    `(spacemacs-emacs-face               ((,class (:background ,dp_dark_yellow  ))))
    `(spacemacs-insert-face              ((,class (:background ,dp_green        ))))
    ;; `(spacemacs-motion-face              ((,class (:background ,dp_))))
    `(spacemacs-normal-face              ((,class (:background ,dp_dark_yellow  ))))
    `(spacemacs-replace-face             ((,class (:background ,dp_light_red    ))))
    `(spacemacs-visual-face              ((,class (:background ,dp_dark_blue    ))))
