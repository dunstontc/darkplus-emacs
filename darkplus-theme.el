...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
       (dp_light_grey    "#d4d4d4")
       (dp_dark_grey     "#1E1E1E")
       (dp_dark_blue     "#569CD6")
       (dp_pink          "#C586C0")
       (dp_comment_green "#505050")
       (dp_yellow        "#DCDCAA")
       (dp_orange        "#CE9178")
       (dp_seafoam       "#4EC9B0")
   ...
   'darkplus
        ...
        `(org-level-1                  ((,class (:bold t :foreground ,dp_dark_blue :height 1.1))))
        ...
        `(org-document-info-keyword    ((,class (:foreground ,dp_dark_grey))))
