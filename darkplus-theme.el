...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'darkplus
        ...
        `(org-level-1                  ((,class (:bold t :foreground ,dp_bright_blue :height 1.1))))
        `(org-level-2                  ((,class (:bold nil :foreground ,dp_dark_blue))))
        ...
        `(org-scheduled-today          ((,class (:foreground ,func :weight bold :height 1.2))))
      	`(org-ellipsis                 ((,class (:foreground ,dp_grey))))
	      `(org-verbatim                 ((,class (:foreground ,fg4))))
        `(org-document-info-keyword    ((,class (:foreground ,dp_grey))))
      	`(org-sexp-date                ((,class (:foreground ,fg4))))
        `(org-meta-line                ((,class (:foreground ,dp_grey))))
